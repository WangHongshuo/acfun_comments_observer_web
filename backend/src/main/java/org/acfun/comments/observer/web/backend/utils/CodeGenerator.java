...
public class CodeGenerator {
    ...
    private static final String mapperXmlDir = System.getProperty("user.dir") + "/backend/src/main/resources/mapper";
    ...
    public static void generator(String dbUrl, String dbName, String dbUserName, String dbPassword,
        ...
        FastAutoGenerator.create(dataSourceConfig)
                ...
                .strategyConfig(builder -> {
                    builder.addInclude(tableNames).entityBuilder().enableLombok().enableFileOverride()
